...
class TestWAVParserInitialization:
    ...
    def test_init_with_string_path(self, valid_pcm_wav):
        ...
        assert parser.format_info is None
    ...
    def test_init_nonexistent_file(self, temp_wav_dir):
        ...
        # Should initialize fine, error occurs during parse
        assert parser.file_path.name == "nonexistent.wav"
...
class TestValidation:
    ...
    def test_get_info_before_parse(self, valid_pcm_wav):
        """Test calling get_info before parse raises error."""
        parser = WAVParser(valid_pcm_wav['filepath'])
